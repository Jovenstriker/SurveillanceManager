# SurveillanceManager
Developed a Java (~10k line) surveillance manager that can trace back which people were called using hand-implemented data structures. Includes runtime analysis, UML diagram, unit-tested code, project proposal (includes why I chose certain data structures, not just all hashmaps), system test plans, and pseudocode algorithm design.
